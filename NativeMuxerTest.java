Google Git Sign in android/platform/cts/refs/heads/android14-release/./tests/tests/media/muxer/src/android/media/muxer/cts/NativeMuxerTest.java blob:24ef 22 a2116d55d01f715a5c3a84725fb11cdfd1[file][log][blame]
/*
...
public class NativeMuxerTest extends MediaTestBase {
    ...
    private void testMuxer(final String res, boolean signalEos) throws Exception {
        ...
        // allow duration mismatch for webm files as ffmpeg does not consider the
        // duration of the
        ...
        remux.release();
        Preconditions.assertTestFileExists(MEDIA_DIR + res);
        MediaPlayer player1 = MediaPlayer.create(mContext, Uri.fromFile(new File(MEDIA_DIR + res)));
    ...
    /**
     * returns: null if key is in neither formats, true if they match and false
     * otherwise
     */
