Google Git Sign in android/platform/cts/refs/heads/android14-release/./tests/media/src/android/mediav2/cts/DecoderHDRInfoTest.java blob:68 cb56672a42630d9795942289e8a1679d69acae[file][log][blame]
/*
 ...
 * file to application
 * correctly. Whether this information is used by the device during display is
 * beyond the scope
 * of this test.
 */
...
public class DecoderHDRInfoTest extends HDRDecoderTestBase {
    ...
    public static Collection<Object[]> input() {
        ...
        final List<Object[]> exhaustiveArgsList = Arrays.asList(new Object[][] {
                // codecMediaType, testFile, hdrStaticInfo in stream, hdrStaticInfo in
                // container,
