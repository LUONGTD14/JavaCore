Google Git Sign in android/platform/cts/refs/heads/android14-release/./tests/tests/media/common/src/android/media/cts/MediaPlayerTestBase.java blob:78054 afa757d2743aecc880b855f3abe7bbdda0d[file][log][blame]
/*
...
public class MediaPlayerTestBase extends MediaTestBase {
     ...
     *                 with a non-negative value, this method stops the playback
     *                 after the length of
     *                 time or the duration the video is elapsed. With a value of
     *                 -1,
     *                 this method simply starts the video and returns immediately
     *                 without
