Google Git Sign in android/platform/cts/refs/heads/android14-release/./tests/media/common/src/android/mediav2/common/cts/EncoderProfileLevelTestBase.java blob:4d 9 c885f77999c8f20b074d5d5e1c4ab8a2469ad[file][log][blame]
/*
...
public class EncoderProfileLevelTestBase extends CodecEncoderTestBase {
    ...
    protected MediaFormat validateProfileAndLevel() throws IOException {
        ...
        // check if output format is in accordance with configured profile and level
        // info.
        ...
        // check if extracted output profile and level information are in accordance
        // with
        ...
        if (mMuxOutput && !mMediaType.equals(MediaFormat.MIMETYPE_VIDEO_H263)) {
            ...
            // directly available as HLS in H263 header. That information is conveyed
            // through
