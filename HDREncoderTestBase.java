Google Git Sign in android/platform/cts/refs/heads/android14-release/./tests/media/common/src/android/mediav2/common/cts/HDREncoderTestBase.java blob:e6fa7c00521e9dba68ce596a0fef31debbab861a[file][log][blame]
/*
...
public class HDREncoderTestBase extends CodecEncoderTestBase {
    ...
    public void validateHDRInfo(String hdrStaticInfo, Map<Integer, String> hdrDynamicInfo)
        ...
        mHdrStaticInfo = hdrStaticInfo != null
                ? ByteBuffer.wrap(loadByteArrayFromString(hdrStaticInfo))
                : null;
        ...
        if (mHdrDynamicInfo != null) {
            Integer lastHdr10PlusFrame = Collections.max(HDR_DYNAMIC_INFO.entrySet(), Map.Entry.comparingByKey())
                    .getKey();
        ...
        HDRDecoderTestBase decoderTest = new HDRDecoderTestBase(decoder, mMediaType, mMuxedOutputFile, mAllTestParams);
