Google Git Sign in android/platform/cts/refs/heads/android14-release/./tests/media/common/src/android/mediav2/common/cts/HDRDecoderTestBase.java blob:c158b240453572018c169d4b1a170c76a915c7b6[file][log][blame]
/*
...
public class HDRDecoderTestBase extends CodecDecoderTestBase {
    ...
    public void validateHDRInfo(String hdrStaticInfoStream, String hdrStaticInfoContainer,
        ...
        mHdrStaticInfoStream = hdrStaticInfoStream != null
                ? ByteBuffer.wrap(loadByteArrayFromString(hdrStaticInfoStream))
                : null;
        mHdrStaticInfoContainer = hdrStaticInfoContainer != null
                ? ByteBuffer.wrap(loadByteArrayFromString(hdrStaticInfoContainer))
                : null;
        mHdrStaticInfoRef = mHdrStaticInfoStream == null ? mHdrStaticInfoContainer : mHdrStaticInfoStream;
        mHdrDynamicInfoStream = hdrDynamicInfoStream;
        mHdrDynamicInfoContainer = hdrDynamicInfoContainer;
        mHdrDynamicInfoRef = hdrDynamicInfoStream == null ? hdrDynamicInfoContainer : hdrDynamicInfoStream;
        ...
        // For decoders, if you intend to supply hdr10+ info using external means like
        // json, make
